...
deploy_mkl_openmp: swig/_tomlib_wrap.cpp
	CC=g++-mp-6 CXX=g++-mp-6 CFLAGS="-fopenmp -Wa,-q -g0 -march=native -O2 -DEIGEN_USE_MKL_ALL ${MKL_CFLAGS} -Wno-enum-compare" LDFLAGS="${MKL_LDFLAGS}" $(PYTHON) setup.py install --user
